...
% Packages for academic icons
% I already put them in the cls file
...
\name{}{Junli Zhang}
%\address{2950 Portage Bay W APT 309, Davis, CA, USA}
\address{Department of Plant Sciences, University of California, One Shields Ave. MS4, Davis, CA 95616}
\mobile{(+1) 208-596-3521}

\email{psjzhang@ucdavis.edu}
%\homepage{zhjl86.wordpress.com}
\github{pinbo}
\linkedin{junli-zhang-2016}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
\twitter{aswillow}
%\researchgate{Junli\_Zhang6}

\position{Postdoctoral Scholar{\enskip\cdotp\enskip}UC Davis} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Junli Zhang~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
